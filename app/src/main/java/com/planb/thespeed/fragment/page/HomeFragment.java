...
import com.planb.thespeed.activity.ManageBasketActivity;
import com.planb.thespeed.activity.RegisterLocationActivity;
import com.planb.thespeed.activity.SearchActivity;
...
public class HomeFragment extends Fragment implements View.OnClickListener, ISaveAddress {
    ...
    private static com.planb.thespeed.model.Address mAddress;
     ...
     * @return HomeFragment
     */
    public static HomeFragment getInstance(com.planb.thespeed.model.Address address) {
        mAddress = address;
    ...
    private void getGeoCode(double longitude, double latitude) {
        ...
        Geocoder geocoder = new Geocoder(getActivity());
         try {
             ...
             if (mAddress == null) {
                 mAddress = new com.planb.thespeed.model.Address();
             }
