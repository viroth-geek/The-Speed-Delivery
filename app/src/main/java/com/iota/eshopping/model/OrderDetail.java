...
import com.iota.eshopping.model.magento.order.ExtensionAttributes;
import com.iota.eshopping.model.modelForView.*;
...
public class OrderDetail extends Entity implements Comparable<OrderDetail> {
    ...
    @Expose
    private List<com.iota.eshopping.model.modelForView.ProductItem> productItems = null;
     ...
     * @return
     */
    public List<com.iota.eshopping.model.modelForView.ProductItem> getProductItems() {
        return productItems;
    }
     ...
     * @param productItems
     */
    public void setProductItems(List<com.iota.eshopping.model.modelForView.ProductItem> productItems) {
