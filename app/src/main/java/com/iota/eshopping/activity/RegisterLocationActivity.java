...
import com.iota.eshopping.model.direction.Leg;
import com.iota.eshopping.model.direction.Route;
import com.iota.eshopping.model.direction.Step;
...
import com.iota.eshopping.security.FeeCalculation;
import com.iota.eshopping.service.base.InvokeOnCompleteAsync;
import com.iota.eshopping.service.datahelper.datasource.online.FetchDriverLastLocation;
import com.iota.eshopping.service.datahelper.datasource.online.FetchDriverLocationHistoryByOrderId;
import com.iota.eshopping.service.datahelper.datasource.online.GetDirection;
...
//        updateUI();
    ...
    private Location getLocationFromIntent() {
        ...
        com.iota.eshopping.model.Address address;
        ...
        if (getIntent().hasExtra(ConstantValue.ADDRESS)) {
            address = (com.iota.eshopping.model.Address) getIntent().getExtras().get(ConstantValue.ADDRESS);
        }
        else {
            ...
            if (addressList != null) {
                if (!addressList.isEmpty()) {
                    if (addressList.size() > 0) {
                        ...
                        com.iota.eshopping.model.Address add = new com.iota.eshopping.model.Address();
