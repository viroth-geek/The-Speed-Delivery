package com.iota.eshopping.service.datahelper.mapper.magentoRestructurer;

import com.google.android.gms.maps.model.LatLng;
import com.iota.eshopping.constant.ApplicationConfiguration;
import com.iota.eshopping.constant.json.StoreDetailAttribute;
...
import com.iota.eshopping.service.datahelper.mapper.DataForm;
import com.iota.eshopping.util.DateUtil;
import com.iota.eshopping.util.LocationUtils;
...
public class MagentoStoreViewsRestructurer implements DataForm {
    ...
    @Override
    public List<ProductCategory> getProductCategoriesByDetail(Map<Catalog, List<com.iota.eshopping.model.Product>> listMap) {
        return null;
    }
    ...
    public List<ProductCategory> margeProductCategoryV2(List<Category> categories) {
        ...
        for (Category category : categories) {
            ...
            for (com.iota.eshopping.model.Product productDetail : category.getProducts()) {
